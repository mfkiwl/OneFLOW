...
module field_module
    use global, only: nx, ighost
    implicit none
    real(8) :: u(-ighost:nx+ighost), un(-ighost:nx+ighost)
...
subroutine update_oldfield(un, u, nx, ighost)
    implicit none
    integer :: nx, ighost
    real(8) :: un(-ighost:nx+ighost), u(-ighost:nx+ighost)
    integer :: i
...
subroutine init_field()
    ...
    call boundary( u, nx, ighost )
    call update_oldfield(un, u, nx, ighost)    
